...
do_action( 'hootubix_template_before_content_grid', 'archive-product.php' );
?>
...
<div class="grid main-content-grid">
	...
	<?php
	// Template modification Hook
	do_action( 'hootubix_template_before_main', 'archive-product.php' );
	?>
	...
	<main <?php hybridextend_attr( 'content' ); ?>>
		...
		<?php
		// Template modification Hook
		do_action( 'hootubix_template_main_start', 'archive-product.php' );
		...
		<?php if ( have_posts() ) : ?>
			...
			<div id="content-wrap">
				...
				<?php
				// Template modification Hook
				do_action( 'hootubix_template_before_loop_nav', 'archive-product.php' );
		...
		// Template modification Hook
		do_action( 'hootubix_template_main_end', 'archive-product.php' );
		?>
	...
	<?php
	// Template modification Hook
	do_action( 'hootubix_template_after_main', 'archive-product.php' );
	?>
