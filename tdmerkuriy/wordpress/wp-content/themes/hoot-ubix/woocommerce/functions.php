...
function hootubix_woo_register_sidebars() {
	hybrid_register_sidebar(
		array(
			'id'          => 'hootubix-woocommerce-sidebar',
	...
	hybrid_register_sidebar(
		array(
			'id'          => 'hootubix-woocommerce-sidebar-secondary',
 ...
 * @return int
 */
if ( !function_exists('hootubix_woo_loop_per_page') ) {
function hootubix_woo_loop_per_page( $value ) {
	return intval( hootubix_get_mod( 'wooshop_products' ) );
}
}
add_filter( 'loop_shop_per_page', 'hootubix_woo_loop_per_page', 20 );
 ...
 * @return int
 */
if ( !function_exists('hootubix_woo_loop_columns') ) {
function hootubix_woo_loop_columns( $value ) {
	return intval( hootubix_get_mod( 'wooshop_product_columns' ) );
}
}
add_filter( 'loop_shop_columns', 'hootubix_woo_loop_columns', 999 );
 ...
 * @return void
 */
if ( !function_exists('hootubix_woo_custom_loop_columns_css') ) {
function hootubix_woo_custom_loop_columns_css() {
	$columns = hootubix_get_mod( 'wooshop_product_columns' );
...
add_action( 'wp_enqueue_scripts', 'hootubix_woo_custom_loop_columns_css', 99 );
 ...
 * @return void
 */
function hootubix_woo_set_queried_object( $q ){
	if ( $q->is_main_query() )
		$r = get_queried_object();
}
add_action( 'pre_get_posts', 'hootubix_woo_set_queried_object', 9 );
