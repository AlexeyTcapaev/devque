...
final class HybridExtend_Customize {
	 ...
	 *
	 * Avoid using 'recursive' merge as array_replace_recursive is only available in PHP5.3
	 * and unfortunately we still have a lot of users on the legac PHP versions
	 *
	 * @since 2.0.0
	 * @access public
	 * @return void
	 */
	public function edit_settings( $new_options, $merge = 'merge' ) {
	 ...
	 * @return void
	 */
	public function edit_sections( $new_options, $merge = 'merge' ) {
		if ( is_array( $new_options ) ) {
	 ...
	 * @return void
	 */
	public function edit_panels( $new_options, $merge = 'merge' ) {
		if ( is_array( $new_options ) ) {
