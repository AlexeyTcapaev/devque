 ...
 */
$display_loop_meta = apply_filters( 'hootubix_default_loop_meta', true );
					...
					<div class="grid">
						...
						<div <?php hybridextend_attr( 'loop-meta', '', 'grid-span-12' ); ?>>
							<div class="entry-header">
								...
								<?php $hide_meta_info = apply_filters( 'hootubix_hide_meta_info', false, 'top' ); ?>
								<?php if ( !$hide_meta_info && 'top' == hootubix_get_mod( 'post_meta_location' ) && !is_attachment() ) : ?>
									<div <?php hybridextend_attr( 'loop-description' ); ?>>
										<?php
										if ( is_page() )
											hootubix_meta_info_blocks( hootubix_get_mod('page_meta'), 'loop-meta' );
										else
											hootubix_meta_info_blocks( hootubix_get_mod('post_meta'), 'loop-meta' );
										?>
									</div><!-- .loop-description -->
								<?php endif; ?>
