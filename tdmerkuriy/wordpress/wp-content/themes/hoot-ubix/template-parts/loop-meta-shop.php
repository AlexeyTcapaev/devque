 ...
 */
$display_loop_meta = apply_filters( 'hootubix_woo_loop_meta', true );
do_action ( 'hootubix_woo_loop_meta', 'start' );
...
elseif ( is_product() ) :
	...
	add_filter( 'loop_meta_display_title', 'hootubix_hide_loop_meta_woo_product' );
 ...
 * Template modification Hooks
 */
do_action ( 'hootubix_woo_loop_meta', 'end' );