...
?>
	...
	<article <?php hybridextend_attr( 'page' ); ?>>
		...
		<?php $hide_meta_info = apply_filters( 'hootubix_hide_meta_info', false, 'bottom' ); ?>
		<?php if ( !$hide_meta_info && 'bottom' == hootubix_get_mod( 'post_meta_location' ) ): ?>
			<footer class="entry-footer">
				<?php hootubix_meta_info_blocks( hootubix_get_mod('page_meta'), 'page' ); ?>
			</footer><!-- .entry-footer -->
		<?php endif; ?>
 ...
 */
	...
	if ( empty( $hootubix_theme->searchresults_hide_pages ) ) {
