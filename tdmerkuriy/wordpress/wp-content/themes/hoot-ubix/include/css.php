...
function hootubix_dynamic_cssrules() {
	...
	$settings = array();
	$settings['grid_width']           = intval( hootubix_get_mod( 'site_width', 1260 ) ) . 'px';
	...
	$settings['content_bg_color']     = ( $settings['site_layout'] == 'boxed' ) ?
	                                        ...
	                                        hootubix_get_mod( 'background_color' );
	$settings['site_title_icon_size'] = hootubix_get_mod( 'site_title_icon_size' );
	$settings['site_title_icon']      = hootubix_get_mod( 'site_title_icon' );
