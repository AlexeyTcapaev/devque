...
function hootubix_theme_custom_image_sizes( $sizes ) {
	$sizes = array(
		// Let span3 use 'hootubix-medium-thumb' as we need width to be 420 for mobile
		// // 240 x 180 (suitable for span3, calculated using logic of hybridextend_get_image_size_name fn)
		// 'hootubix-small-thumb' => array(
		...
		// 393 x 180 (width is 425 instead of 420, so that 'hootubix-medium-thumb' stays as default for span4. 'hootubix-preview' is used for archive-medium post thumbnails)
		'hootubix-preview' => array(
