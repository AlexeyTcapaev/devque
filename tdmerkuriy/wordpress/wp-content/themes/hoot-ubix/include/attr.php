...
add_filter( 'hybrid_attr_menu', 'hootubix_theme_attr_menu', 5, 2 );
...
add_filter( 'hybrid_attr_branding', 'hootubix_theme_attr_branding', 5 );
add_filter( 'hybrid_attr_entry-summary', 'hootubix_theme_attr_entry_summary', 5, 2 );

if ( function_exists( 'hybrid_attr_post' ) )
	add_filter( 'hybrid_attr_page', 'hybrid_attr_post', 5 ); // Alternate for "post".
...
add_filter( 'hybrid_attr_loop-meta-wrap', 'hootubix_theme_attr_loop_meta_wrap', 5 );
add_filter( 'hybrid_attr_loop-meta', 'hootubix_theme_attr_loop_meta', 5 ); // hybrid_attr_archive-header in v3.0.0 ; we use it for generic loop (archive / singular etc )
add_filter( 'hybrid_attr_loop-title', 'hootubix_theme_attr_loop_title', 5 ); // hybrid_attr_archive-title in v3.0.0 ; we use it for generic loop (archive / singular etc )
add_filter( 'hybrid_attr_loop-description', 'hootubix_theme_attr_loop_description', 5 ); // hybrid_attr_archive-description in v3.0.0 ; we use it for generic loop (archive / singular etc )
...
add_filter( 'hybrid_attr_content-block-img', 'hootubix_theme_attr_content_block_img' );
 ...
 * @return array
 */
function hootubix_theme_attr_loop_meta( $attr ) {
 ...
 * @return array
 */
function hootubix_theme_attr_loop_title( $attr ) {
 ...
 * @return array
 */
function hootubix_theme_attr_loop_description( $attr ) {
 ...
 * @return array
 */
function hootubix_theme_attr_content_block_img( $attr ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	$attr['alt'] = __( 'Content Image', 'hoot-ubix' );
	$attr['itemprop'] = 'image';
	return $attr;
}
