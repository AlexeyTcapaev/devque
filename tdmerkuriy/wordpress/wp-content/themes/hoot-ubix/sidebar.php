...
?>
	...
	<aside <?php hybridextend_attr( 'sidebar', 'primary' ); ?>>
		...
		if ( is_active_sidebar( 'hootubix-primary-sidebar' ) ) : // If the sidebar has widgets.

			dynamic_sidebar( 'hootubix-primary-sidebar' ); // Displays the primary sidebar.
	...
	?>
		...
		<aside <?php hybridextend_attr( 'sidebar', 'secondary' ); ?>>
			...
			if ( is_active_sidebar( 'hootubix-secondary-sidebar' ) ) : // If the sidebar has widgets.

				dynamic_sidebar( 'hootubix-secondary-sidebar' ); // Displays the secondary sidebar.
