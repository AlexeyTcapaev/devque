...
?>
	...
	<aside <?php hybridextend_attr( 'sidebar', 'primary' ); ?>>
		...
		if ( is_active_sidebar( 'hootubix-woocommerce-sidebar' ) ) : // If the sidebar has widgets.

			dynamic_sidebar( 'hootubix-woocommerce-sidebar' ); // Displays the woocommerce sidebar.
	...
	?>
		...
		<aside <?php hybridextend_attr( 'sidebar', 'secondary' ); ?>>
			...
			if ( is_active_sidebar( 'hootubix-woocommerce-sidebar-secondary' ) ) : // If the sidebar has widgets.

				dynamic_sidebar( 'hootubix-woocommerce-sidebar-secondary' ); // Displays the woocommerce sidebar.
