...
(function (root, factory) {
  ...
  Gallery.prototype._handleThumbClick = function (event) {
    ...
    if (this._setupComplete && this._fullImgsLoaded && !this._fullImgOpen) {
      this._activateFullImg(this)
      this._activateControls(this)
      this._activateFullBox(this)
      this._disableScroll()
    }
  }
  ...
  Gallery.prototype._closeFullImg = function () {
    var animation = function () {
      ...
      this._fullImg.dispatchEvent(new Event(transitionendString))
      this._enableScroll()
    }.bind(this)
