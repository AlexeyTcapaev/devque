...
var update = __webpack_require__(73)("448dc072", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    if (this.slide !== undefined) {
      ...
      this.targetproduct = this.products.find(function (prod) {
        if (+prod.id === +_this.item.products_id) return prod;
      });
