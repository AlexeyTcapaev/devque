    ...
    <div class="container">
        ...
        <div class="row form">
           <div class="input-field col s3">
                <v-btn depressed small class="btn-flat "><i class="material-icons">account_circle</i></v-btn>
                <input class="my-input" id="username" type="text" required placeholder="ЛОГИН" v-model="name">
            </div>
            <div class="input-field col s3">
                <v-btn depressed small class="btn-flat"><i class="material-icons">email</i></v-btn>
                <input class="my-input" id="username" type="text" required placeholder="E-mail" v-model="email">
            </div>
            <div class="input-field col s3">
                <v-btn depressed small class="btn-flat"><i class="material-icons">vpn_key</i></v-btn>
