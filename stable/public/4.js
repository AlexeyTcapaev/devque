...
var update = __webpack_require__(70)("25f29e17", content, false, {});
    ...
    loging: function loging() {
      ...
      axios.post("/api/login", {
        ...
        axios.post("/api/user/details", {}, {
          ...
          __WEBPACK_IMPORTED_MODULE_0_js_cookie___default.a.set("name", resp.data.success.name);
          __WEBPACK_IMPORTED_MODULE_0_js_cookie___default.a.set("id", resp.data.success.id);
